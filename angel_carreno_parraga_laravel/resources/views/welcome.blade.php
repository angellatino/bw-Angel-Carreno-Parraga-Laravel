    ...
    <div class="container py-4">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <!-- Latest Transfer Rumors Section -->
                <div class="mt-3">
                    <h4 class="mb-4">Latest Transfer Rumors</h4>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><small class="text-muted">Published on {{ $post->published_at->format('Y-m-d') }}</small></p>
                        </div>
                    </div>
                    @endforeach
                </div>
